label b1_end:
    ...
    if not Josh_joined_team:
        menu:
            ...
            "Yes":
                call add_Josh from _call_add_Josh
                pass
            "No":
                pass
    ...
    if not Brigette_joined_team:
        menu:
            ...
            "Yes":
                call add_Brigette from _call_add_Brigette
                pass
            "No":
                pass
...
label breakout_room_1:
    ...
    menu:
        "Hey! How are you guys doing?":
            call b1_howareyou from _call_b1_howareyou
            pass
        "Ooh.. did I interrupt something?":
            call b1_interrupt from _call_b1_interrupt
            pass
...
label b1_continue:
    ...
    menu:
        "How did you guys meet?":
            call b1_howtheymet from _call_b1_howtheymet
            pass
        "Excuse me, what did you say?":
            Brigette "No nothing at all haha."
            Josh "?"
            call b1_tellus from _call_b1_tellus
            pass
        "Cute teddy bear in the background Brigette!":
            call b1_teddybear from _call_b1_teddybear
            pass
...
label b1_teddybear:
    ...
    call b1_tellus from _call_b1_tellus_1
    return
...
label b1_howtheymet:
    ...
    Josh "?"
    Josh "..."
    call b1_tellus from _call_b1_tellus_2
    return
...
label b1_tellus:
    ...
    menu:
        "I like music!":
            ...
            show Brigette_twob at top_right_screen
            Brigette "Hmph."
            call b1_end from _call_b1_end                           # END ABRUPT
            pass
        "I enjoy science!":
            ...
            Brigette "..."
            Josh "It's true!!"
            call b1_end from _call_b1_end_1                          #     EN D LOL
        ...
        "I don't want to talk about anything...":
            ...
            call b1_end from _call_b1_end_2                                 # END ABRUPT LOL
    return
...
label b1_cutoff:
    ...
    menu:
        "Looks like it's just us two now.":
            call b1_justtwo from _call_b1_justtwo
            pass
        "Cool guitar you got there!":
            Josh "Thanks, it's cool isn't it?"
            call b1_coolguitar from _call_b1_coolguitar
            pass
    return
        ...
        "So... what are you majoring in?":
            ...
            menu:
                "I think it was my fault.":
                    ...
                    call b1_worktogether from _call_b1_worktogether
                    pass
                "Yeah, I’m not sure either...":
                    call b1_worktogether from _call_b1_worktogether_1
                    pass
        "How’s quarantine?":
            Josh "It’s been chill! I’ve just been playing on my guitar lately… honestly been practising like mad."
            call b1_coolguitar from _call_b1_coolguitar_1
...
label b1_coolguitar:
    ...
    menu:
        "Ah... I’m sorry for your loss dude.":
            call b1_sorryloss from _call_b1_sorryloss
        "Uhh, you selling it? I think it’s just what I need.":
            ...
            call b1_end from _call_b1_end_3                                                 #END
...
label b1_sorryloss:
    ...
    call b1_end from _call_b1_end_4                                         #END
    return
...
label b1_worktogether:
    ...
    menu:
        "Of course!":
            ...
            call add_Josh from _call_add_Josh_1
            call b1_end from _call_b1_end_5
            pass
        "Sorry, I’m working with someone else.":
            Josh "Nah all good man. Good luck on the project!"                    # END
            call b1_end from _call_b1_end_6
            pass
